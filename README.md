...
Pre-built binaries are available for Linux, macOS (Intel & Apple Silicon), and Windows. See [INSTALL.md](INSTALL.md) for detailed installation instructions.

**Quick start:**
- Download the latest release from [GitLab Releases](https://gitlab.com/arnops/ifo/-/releases)
